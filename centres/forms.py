...
class CommentaireForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['texte']
        widgets = {
            'texte': forms.Textarea(attrs={'rows': 4, 'placeholder': 'Votre commentaire...'}),
        }
...
class FormationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'description': forms.Textarea(attrs={'rows': 5, 'placeholder': 'Description de la formation...'}),
...
class PersonneForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'attentes': forms.Textarea(attrs={'rows': 4, 'placeholder': 'Vos attentes...'}),
        }
